...
class SystemTypeSystemMaintenanceForm(ModelForm):
    '''
    '''
    ...
    class Meta:
        ...
        exclude = ('work_type','work_description',)

class SystemTypeMaintenanceForm(ModelForm):
    ''' form for editing MaintenanceInstructionForm
    '''
    
    def __init__(self, *args, **kwargs):
        super(SystemTypeMaintenanceForm, self).__init__(*args, **kwargs)
